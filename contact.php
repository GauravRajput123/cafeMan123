...
<html lang="en">
  ...
  <a class="nav-link" href="fnq.php">FAQ</a>
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/contact.jpg)">
                          <div class="detail-box p-4">
                            ...
                            <div class="round-social light">
                              ...
                              <a href="https://github.com/GauravRajput123/cafeMan123.git" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-github"></i></i></a>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" id="messagebd">
              <table class="table-striped table-bordered col-md-12 text-center">
                ...
                <tbody>
                <?php 
                   $sql = "SELECT * FROM contactreply WHERE userId=$1";
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" id="bd">
              <table class="table-striped table-bordered col-md-12 text-center">
                ...
                <tbody>
                <?php 
                   $sql = "SELECT * FROM contact WHERE userId=$1";
                   $result = pg_query_params($conn, $sql, array($userId));
                   $count = 0;
                   while ($row = pg_fetch_assoc($result)) {
                       $contactId = $row['contactid'];
