...
<body>
    ...
    <div class="container my-3">
        ...
        <?php 
           $noResult = true;
           $query = $_GET["search"];
           $sql = 'Select * from public.categories where "categorieName" like \'%'.$query.'%\';';
    ...
    <div class="container my-3" id="cont">
        ...
        <?php 
            $query = $_GET["search"];
            $sql = 'Select * from public.pizza where "pizzaName"  like \'%'.$query.'%\';';
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center">';
                                if ($loggedin) {
                                    $quaSql = "SELECT \"itemQuantity\" FROM viewcart WHERE \"pizzaId\" = $1 AND \"userId\"=$2";
