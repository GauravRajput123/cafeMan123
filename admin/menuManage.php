                            ...
                            <?php
								...
								$result = pg_query($conn, $sql);
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <img src="/caffes_project/img/pizza-'.$pizzaId. '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
...
<?php 
	...
	$pizzaResult = pg_query($conn, $pizzasql);
	while ($pizzaRow = pg_fetch_assoc($pizzaResult)) {
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/caffes_project/img/pizza-<?php echo $pizzaId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="partials/_menuManage.php" method="post">
